...
class MessageEnrichment(object):
    ...
    discriminator_value_class_map = {
            ...
            'numerical'.lower(): '#/components/schemas/NumericMessageEnrichment',
            'array'.lower(): '#/components/schemas/ArrayMessageEnrichment',
            'text'.lower(): '#/components/schemas/TextMessageEnrichemnt',
    }
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(MessageEnrichment, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MessageEnrichment):
            return False
