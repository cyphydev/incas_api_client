...
from uiuc_incas_client import rest
from uiuc_incas_client.configuration import Configuration
from uiuc_incas_client.exceptions import ApiTypeError, ApiValueError, ApiException
from uiuc_incas_client.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = ActorApi()
        api_instance.actor_enrichments_get  # this is an instance of the class Endpoint
        api_instance.actor_enrichments_get()  # this invokes api_instance.actor_enrichments_get.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.actor_enrichments_get.callable or self.callable in this class
