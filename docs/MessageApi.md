...
# create an instance of the API class
api_instance = swagger_client.MessageApi()
body = [swagger_client.MessageEnrichmentMeta()] # list[MessageEnrichmentMeta] | The new enrichment meta to add
...
# create an instance of the API class
api_instance = swagger_client.MessageApi()
body = [swagger_client.MessageEnrichmentMeta()] # list[MessageEnrichmentMeta] | The new enrichment meta to update
enrichment_name = 'enrichment_name_example' # str |  (optional)
provider_name = 'provider_name_example' # str |  (optional)
version = 'version_example' # str |  (optional)
...
# create an instance of the API class
api_instance = swagger_client.MessageApi()
body = [swagger_client.MessageEnrichment()] # list[MessageEnrichment] | The new enrichment to add
id = 'id_example' # str | Message ID
...
# create an instance of the API class
api_instance = swagger_client.MessageApi()
body = [swagger_client.MessageEnrichment()] # list[MessageEnrichment] | The new enrichments to update
enrichment_name = 'enrichment_name_example' # str | 
provider_name = 'provider_name_example' # str | 
version = 'version_example' # str | 
id = 'id_example' # str | Message ID
