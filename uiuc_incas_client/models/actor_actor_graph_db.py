...
class ActorActorGraphDB(BaseGraph):
    ...
    swagger_types = {
        'enrichment_name': 'str',
        'edges': 'dict(str, ActorToActorEdge)'
    }
    ...
    def __init__(self, enrichment_name=None, edges=None, *args, **kwargs):  # noqa: E501
        """ActorActorGraphDB - a model defined in Swagger"""  # noqa: E501
    ...
    def enrichment_name(self):
        """Gets the enrichment_name of this ActorActorGraphDB.  # noqa: E501

        The type of enrichment used to construct the act2act graph.  # noqa: E501

        :return: The enrichment_name of this ActorActorGraphDB.  # noqa: E501
        :rtype: str
        """
    ...
    def enrichment_name(self, enrichment_name):
        """Sets the enrichment_name of this ActorActorGraphDB.

        The type of enrichment used to construct the act2act graph.  # noqa: E501

        :param enrichment_name: The enrichment_name of this ActorActorGraphDB.  # noqa: E501
        :type: str
        """
    ...
    @property
    def edges(self):
        """Gets the edges of this ActorActorGraphDB.  # noqa: E501


        :return: The edges of this ActorActorGraphDB.  # noqa: E501
        :rtype: dict(str, ActorToActorEdge)
        """
        return self._edges

    @edges.setter
    def edges(self, edges):
        """Sets the edges of this ActorActorGraphDB.


        :param edges: The edges of this ActorActorGraphDB.  # noqa: E501
        :type: dict(str, ActorToActorEdge)
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ActorActorGraphDB, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ActorActorGraphDB):
            return False
